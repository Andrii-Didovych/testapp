package com.didovych;

import com.didovych.controller.MainController;
...
public class MainControllerTest {
    ...
    public void addMessageToListTest() throws Exception {
        ...
        this.mockMvc.perform(multipart)
                ...
                .andExpect(xpath("//*[@id='message-list']/div[@data-id='5']").exists())
                .andExpect(xpath("//*[@id='message-list']/div[@data-id='5']/div/span").string("fifth"))
                .andExpect(xpath("//*[@id='message-list']/div[@data-id='5']/div/i").string("#new one"));
    }
}
